...
public class Player {
    ...
    public void draw(Graphics g) {
        ...
        if (corazonCompleto != null) {
            ...
            int inicioX = 50; // Posici�n X inicial para dibujar corazones
            int inicioY = 30; // Posici�n Y para dibujar corazones
    ...
    public boolean verificarSaltoPlataforma() {
        // Asume que el jugador est� sobre la plataforma si el borde inferior del jugador est� cerca del borde superior de la plataforma
