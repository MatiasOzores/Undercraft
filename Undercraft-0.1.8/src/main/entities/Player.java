...
public class Player {
    ...
    public Player(int x, int y, int width, int height, int speed, Color color, 
            ...
            Image playerImageLeft1, Image playerImageLeft2, Image playerImageLeftStatic, Image playerImageRightStatic, Image corazonCompleto) {
        this.x = x;
        this.y = y;
        this.width = width;
        this.height = height;
    ...
    public boolean verificarSaltoPlataforma() {
        if(x + width - 10 >= Plataforma.x && x + 10 < Plataforma.x + Plataforma.width) {
        	return y != Plataforma.y-height;
        }
