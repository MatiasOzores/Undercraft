...
public class Arrow {
    ...
    private boolean hasCollided = false; // Indica si la flecha ya colision�
    ...
    public void update() {
        ...
        // Verificar colisi�n con el jugador solo si no ha colisionado antes
    ...
    public void draw(Graphics g) {
        ...
        g.fillRect(x, y, width, height); // Dibujar la flecha como un rect�ngulo
    }
    ...
    public boolean isOutOfBounds() {
        // Verificar si la flecha sale de los l�mites de la pantalla
    ...
    private boolean isCollidingWithPlayer() {
        ...
        // Comprobar si la flecha est� dentro de los l�mites del jugador
