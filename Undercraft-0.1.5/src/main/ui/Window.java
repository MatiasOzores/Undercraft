...
public class Window extends JFrame implements Runnable, KeyListener {
	...
	public Window() {
        ...
        try {
        	...
        	playerImage = ImageIO.read(getClass().getResource("SteveSpriteRight.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
	    ...
	    player = new Player(WIDTH / 2 - 50, ((Window.HEIGHT/2) + 150) - 70, 64, 64, 5, Color.yellow, playerImage);
