...
public class Window extends JFrame implements Runnable, KeyListener {
	...
	public Window() {
        ...
        player = new Player(30, ((Window.HEIGHT / 2) + 150) - 70, 64, 64, 5, Color.yellow, 
                playerImageRight1, playerImageRight2, playerImageLeft1, playerImageLeft2, playerImageLeftStatic, playerImageRightStatic, corazonCompleto);
        ...
        plataforma = new Plataforma(100, 330,200,30,Color.green,player);
	}
